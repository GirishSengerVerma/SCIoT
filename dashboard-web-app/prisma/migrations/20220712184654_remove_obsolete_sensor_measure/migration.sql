/*
  ...
  - The values [SOUND] on the enum `SensorMeasure` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "SensorMeasure_new" AS ENUM ('TEMPERATURE', 'WIND_SPEED', 'HUMIDITY', 'PRESSURE', 'VIBRATION', 'CO', 'CO2', 'WATER_LEVEL', 'RAIN');
